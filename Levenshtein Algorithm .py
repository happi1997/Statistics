# -*- coding: utf-8 -*-
"""
Created on Fri Dec  4 10:27:05 2020
...
print('老大哥',edit_distance(str1,str3))
print('Loki',edit_distance(str1,Loki))
print('学霸哥',edit_distance(str1,QA2))
print('Android',edit_distance(str1,Android)) 